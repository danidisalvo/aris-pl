 ...
 */
public record Conditional(WellFormedFormula wff1, WellFormedFormula wff2) implements WellFormedFormula {

    /**
     * Creates a new conditional of the given well-formed formulae.
     *
